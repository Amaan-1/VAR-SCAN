...
function headup() {
    ...
    var head_1 = "<th id='shorten'>S. No</th>";
    headcell1 = head_1;

    //CREATE the 2nd heading - "GLASS Name"
    var head_2 = "<th id='camel'>GLASS Name</th>";
    headcell2 = head_2;

    //CREATE the 3rd heading - "Result (isPassed)"
    var head_3 = "<th id='camel'>Result [Is Passed?]</th>";
    headcell3 = head_3;

    //CREATE the 4th heading - "Time"
    var head_4 = "<th id='camel'>Time</th>";
    headcell4 = head_4;

    //CREATE the 5th heading - "Date"
    var head_5 = "<th id='camel'>Date</th>";
    headcell5 = head_5;
    ...
    headrow = "<tr id='stand_right'><b>" + uniteHead + "</b></tr>";
